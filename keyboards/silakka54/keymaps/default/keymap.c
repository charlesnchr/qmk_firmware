...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LSFT, LSFT_T(KC_Z),    LT(7, KC_X),    KC_C,    LT(5, KC_V),    KC_B,                               LT(2, KC_N),    LALT_T(KC_M), RGUI_T(KC_COMM),  RCTL_T(KC_DOT),  RSFT_T(KC_SLSH), LCTL_T(KC_RBRC),
    ...
    [2] = LAYOUT(
        ...
        KC_TRNS,  KC_CAPS, KC_TRNS, KC_TRNS, KC_EQL, KC_PLUS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS, KC_TRNS,
