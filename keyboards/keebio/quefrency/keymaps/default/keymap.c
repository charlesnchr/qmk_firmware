...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
          ...
          KC_LCTL, KC_LGUI, KC_LGUI, KC_LALT,  KC_SPC,          _______, KC_SPC, KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, MO(_FN2)
          ),
  ...
  [_FN1] = LAYOUT(
    ...
    KC_TILD, _______, _______, _______, _______,          _______, MO(_FN2), _______, _______, _______, _______, _______
  ),
