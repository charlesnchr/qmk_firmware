...
#define KC_SPFN LT(_fn, KC_SPC) // press for space, hold for function layer (aka spacefn)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_qwerty] = LAYOUT_60_ansi_arrow(
        ...
        KC_CAPS, LGUI_T(KC_F13), KC_LALT,                            KC_SPFN,                             RGUI_T(KC_F13), KC_RCTL,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
