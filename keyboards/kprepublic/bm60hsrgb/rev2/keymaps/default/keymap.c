...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_mac] = LAYOUT_60_ansi_arrow(
        ...
        LCTL_T(KC_ESC),       KC_A,    KC_S,    KC_D,    LCTL_T(KC_F),    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    RCTL_T(KC_SCLN), KC_QUOT, KC_ENT,
        KC_LSFT,                 KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,   RSFT_T(KC_SLSH),   KC_UP, MO(_mouse),
        KC_LCTL, KC_LGUI, KC_LALT,                            LT(_mouse, KC_SPC),                             KC_RGUI, KC_RALT,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
